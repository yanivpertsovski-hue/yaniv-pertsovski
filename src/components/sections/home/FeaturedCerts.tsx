    ...
    <section className="py-24 bg-[var(--surface)]" aria-labelledby="certs-heading">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-end justify-between mb-12" dir="rtl">
          <SectionHeader title={t("certifications")} subtitle={t("certifications_sub")} className="mb-0" />
          <Link href="/certifications" className="hidden sm:flex items-center gap-1.5 text-sm text-[var(--accent)] hover:gap-2.5 transition-all shrink-0">
