...
export function Timeline({ items, locale = "en" }: TimelineProps) {
  return (
    <div className="relative">
      {/* Vertical line */}
      <div className="absolute left-4 top-0 bottom-0 w-px bg-gradient-to-b from-[var(--accent)] via-[var(--border)] to-transparent" />
      ...
      <div className="flex flex-col gap-10">
        {items.map((item, i) => (
          ...
          >
            {/* Dot */}
            <div className="absolute left-2.5 top-1.5 w-3 h-3 rounded-full bg-[var(--accent)] border-2 border-[var(--background)] shadow-[0_0_0_3px_var(--accent-muted)]" />
            ...
            <div className="glass rounded-2xl p-6 flex flex-col gap-4">
              ...
              <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-2">
                ...
                <div className="text-xs text-[var(--muted)] shrink-0 font-mono bg-[var(--surface-2)] px-3 py-1 rounded-full">
