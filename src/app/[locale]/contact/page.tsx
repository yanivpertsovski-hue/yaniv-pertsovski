...
// Note: metadata won't work with "use client" — moved to a separate layout if needed.
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        ...
        >
          ...
          <p className="text-[var(--muted)] text-lg max-w-xl mx-auto leading-relaxed">
            Whether you have a security challenge, infrastructure project, or just want to
